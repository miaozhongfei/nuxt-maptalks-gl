...
const plugins = ref([
  ...
  { name: 'mapbox-gl-js-maptalks', status: 'loading', note: 'Mapbox GL JS 图层。', el: null as HTMLElement | null, importFn: () => import('mapbox-gl-js-maptalks').then(m => (m as Record<string,unknown>).MapboxglLayer) },
]);
