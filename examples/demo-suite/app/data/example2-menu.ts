...
export const example2Menu: Example2Group[] = [
  ...
  },
  {
    ...
    demos: [
      ...
      { no: '3.8', title: '矩形, 圆形, 椭圆和扇形', slug: 'rect-circle-ellipse-sector', implemented: true },
      { no: '3.9', title: '圆弧和贝塞尔曲线', slug: 'arc-bezier', implemented: true },
  ...
  },
  {
    ...
    demos: [
      ...
      { no: '4.6', title: '设置图形高度', slug: 'set-altitude', implemented: true },
    ],
  },
  {
    no: 5,
    ...
    demos: [
      ...
      { no: '5.4', title: '矢量标注模式填充', slug: 'vector-pattern', implemented: true },
      ...
      { no: '5.12', title: '线样式', slug: 'line-style', implemented: true },
      { no: '5.13', title: '线的模式填充', slug: 'line-pattern', implemented: true },
      { no: '5.14', title: '线的模式填充动画', slug: 'line-pattern-animation', implemented: true },
      { no: '5.15', title: '线的渐变填充', slug: 'line-gradient', implemented: true },
      { no: '5.16', title: '带箭头的线', slug: 'line-arrow', implemented: true },
      { no: '5.17', title: '带文字的线', slug: 'line-text', implemented: true },
      { no: '5.18', title: '端点沿线自动旋转Marker', slug: 'line-marker-rotation', implemented: true },
      { no: '5.19', title: '线的曲线平滑', slug: 'line-smooth', implemented: true },
      { no: '5.20', title: '面样式', slug: 'polygon-style', implemented: true },
      { no: '5.21', title: '面的模式填充', slug: 'polygon-pattern', implemented: true },
  ...
  },
  {
    ...
    slug: 'layer',
    demos: [
      { no: '6.1', title: '添加图层和移除图层', slug: 'add-remove', implemented: true },
      { no: '6.2', title: '隐藏显示图层', slug: 'show-hide', implemented: true },
      { no: '6.3', title: '设置图层透明度', slug: 'layer-opacity', implemented: true },
      { no: '6.4', title: '图层置顶或置底', slug: 'bring-front-back', implemented: true },
      { no: '6.5', title: '改变图层叠加顺序', slug: 'z-order', implemented: true },
      { no: '6.6', title: '用鼠标设置图层遮罩', slug: 'layer-mask', implemented: true },
      { no: '6.7', title: 'globalCompositeOperation', slug: 'composite-operation', implemented: true },
      { no: '6.8', title: 'VectorLayer: 批量添加图形', slug: 'batch-add', implemented: true },
      { no: '6.9', title: 'VectorLayer:根据 ID 获取图形', slug: 'get-by-id', implemented: true },
      { no: '6.10', title: 'VectorLayer: 根据属性条件筛选图形', slug: 'filter', implemented: true },
      { no: '6.11', title: 'VectorLayer: 批量设置图形样式', slug: 'layer-style', implemented: true },
      { no: '6.12', title: 'VectorLayer: 设置图形的z-index', slug: 'geometry-zindex', implemented: true },
      { no: '6.13', title: '图层碰撞', slug: 'collision', implemented: true },
      { no: '6.14', title: 'CanvasLayer: 画板图层示例', slug: 'canvas-layer', implemented: true },
      { no: '6.15', title: 'ParticleLayer: 粒子图层示例', slug: 'particle-layer', implemented: true },
      { no: '6.16', title: 'CanvasTileLayer: 画板瓦片图层示例', slug: 'canvas-tile-layer', implemented: true },
      { no: '6.17', title: '图层卷帘效果', slug: 'layer-swipe', implemented: true },
      { no: '6.18', title: 'ImageLayer: 图片图层示例', slug: 'image-layer', implemented: true },
    ],
  },
  {
    no: 7,
    ...
    slug: 'util',
    demos: [
      { no: '7.1', title: '通过Proxy更新options', slug: 'proxy-options', implemented: true },
    ],
  },
  {
    no: 8,
    ...
    slug: 'interaction',
    demos: [
      { no: '8.1', title: '禁用所有交互', slug: 'disable-interaction', implemented: true },
      { no: '8.2', title: '地图功能开关', slug: 'map-switches', implemented: true },
      { no: '8.3', title: '测距工具', slug: 'distance-tool', implemented: true },
      { no: '8.4', title: '测面工具', slug: 'area-tool', implemented: true },
      { no: '8.5', title: '绘制工具', slug: 'draw-tool', implemented: true },
      { no: '8.6', title: '拖拽图形', slug: 'drag-geometry', implemented: true },
      { no: '8.7', title: '编辑标注', slug: 'edit-marker', implemented: true },
      { no: '8.8', title: '编辑线', slug: 'edit-line', implemented: true },
      { no: '8.9', title: '编辑多边形', slug: 'edit-polygon', implemented: true },
      { no: '8.10', title: '编辑矩形/圆形/椭圆', slug: 'edit-shapes', implemented: true },
      { no: '8.11', title: '编辑文本框', slug: 'edit-textbox', implemented: true },
      { no: '8.12', title: '编辑文本内容', slug: 'edit-text', implemented: true },
      { no: '8.13', title: '鼠标点选图形', slug: 'identify', implemented: true },
      { no: '8.14', title: '鼠标悬停高亮图形', slug: 'hover-highlight', implemented: true },
      { no: '8.15', title: '鼠标与图形的空间关系', slug: 'spatial-relation', implemented: true },
    ],
  },
  {
    no: 9,
    ...
    slug: 'animation',
    demos: [
      { no: '9.1', title: '地图飞行到指定位置', slug: 'fly-to', implemented: true },
      { no: '9.2', title: 'Marker的变形动画', slug: 'marker-animation', implemented: true },
      { no: '9.3', title: '点的沿线动画', slug: 'along-line', implemented: true },
      { no: '9.4', title: 'Geometry.animate方法', slug: 'geometry-animate', implemented: true },
      { no: '9.5', title: '线的动画展现', slug: 'line-show', implemented: true },
      { no: '9.6', title: '面的动画展现', slug: 'polygon-show', implemented: true },
      { no: '9.7', title: '自定义动画', slug: 'custom-animation', implemented: true },
      { no: '9.8', title: '地图跟随动画', slug: 'map-follow', implemented: true },
    ],
  },
  {
    no: 10,
    ...
    slug: 'ui-control',
    demos: [
      { no: '10.1', title: '地图右键菜单', slug: 'map-menu', implemented: true },
      { no: '10.2', title: '图形右键菜单', slug: 'geometry-menu', implemented: true },
      { no: '10.3', title: '自定义右键菜单', slug: 'custom-menu', implemented: true },
      { no: '10.4', title: '地图信息框', slug: 'map-infownd', implemented: true },
      { no: '10.5', title: '图形信息框', slug: 'geometry-infownd', implemented: true },
      { no: '10.6', title: '自定义信息框', slug: 'custom-infownd', implemented: true },
      { no: '10.7', title: '信息框内容支持滚动', slug: 'infownd-scroll', implemented: true },
      { no: '10.8', title: 'UIMarker 对齐', slug: 'ui-marker', implemented: true },
      { no: '10.9', title: 'UI碰撞', slug: 'ui-collision', implemented: true },
      { no: '10.10', title: '信息框绑定MVVM组件', slug: 'infownd-mvvm', implemented: true },
      { no: '10.11', title: 'Toolbar控件', slug: 'toolbar', implemented: true },
      { no: '10.12', title: 'Panel控件', slug: 'panel', implemented: true },
      { no: '10.13', title: '鹰眼控件', slug: 'overview', implemented: true },
      { no: '10.14', title: 'Zoom控件', slug: 'zoom-control', implemented: true },
      { no: '10.15', title: '指北针控件', slug: 'compass-control', implemented: true },
      { no: '10.16', title: 'Scale控件', slug: 'scale-control', implemented: true },
      { no: '10.17', title: 'Attribution控件', slug: 'attribution-control', implemented: true },
      { no: '10.18', title: '控件显示与隐藏', slug: 'control-toggle', implemented: true },
      { no: '10.19', title: '图层选择控件', slug: 'layer-switcher', implemented: true },
    ],
  },
  {
    no: 11,
    ...
    slug: 'json',
    demos: [
      { no: '11.1', title: 'GeoJSON转化为Geometry', slug: 'geojson-to-geometry', implemented: true },
      { no: '11.2', title: 'Geometry转化为GeoJSON', slug: 'geometry-to-geojson', implemented: true },
      { no: '11.3', title: '地图转化为JSON', slug: 'map-to-json', implemented: true },
      { no: '11.4', title: '用JSON载入地图', slug: 'map-from-json', implemented: true },
      { no: '11.5', title: '用JSON复制地图', slug: 'copy-map', implemented: true },
      { no: '11.6', title: '用JSON复制Layer', slug: 'copy-layer', implemented: true },
      { no: '11.7', title: '用JSON复制Geometry', slug: 'copy-geometry', implemented: true },
    ],
  },
  {
    no: 12,
    ...
    slug: 'plugin',
    demos: [
      { no: '12.1', title: 'Mapbox gl 图层', slug: 'mapboxgl-layer', implemented: true },
      { no: '12.2', title: 'HeatLayer: 热力图层示例', slug: 'heat-layer', implemented: true },
      { no: '12.3', title: 'ClusterLayer: 点聚合图层示例', slug: 'cluster-layer', implemented: true },
      { no: '12.4', title: 'Three.js 图层', slug: 'three-layer', implemented: true },
      { no: '12.5', title: 'Echarts 图层', slug: 'echarts-layer', implemented: true },
    ],
  },
  {
    no: 13,
    ...
    slug: 'custom-plugin',
    demos: [
      { no: '13.1', title: '创建新的控件', slug: 'custom-control', implemented: true },
      { no: '13.2', title: '创建新的UI组件', slug: 'custom-ui', implemented: true },
      { no: '13.3', title: '创建地图工具', slug: 'custom-tool', implemented: true },
    ],
  },
  {
    no: 14,
    ...
    slug: 'custom-layer',
    demos: [
      { no: '14.1', title: 'HelloLayer', slug: 'hello-layer', implemented: true },
      { no: '14.2', title: 'HelloLayer交互绘制', slug: 'hello-layer-draw', implemented: true },
      { no: '14.3', title: 'HelloLayer动画图层', slug: 'hello-layer-animation', implemented: true },
    ],
  },
];
