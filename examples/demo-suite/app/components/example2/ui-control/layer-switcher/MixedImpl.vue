<template>
  <div>
    <MaptalksMap
      ...
      style="height: 480px"
    />
    <p class="text-sm text-muted mt-2">MaptalksMap ref + useMaptalksLayerSwitcher——GroupTileLayer 底图候选 + 叠加图层，hover 切换（对应官网 10.19）。</p>
  </div>
</template>
...
// MaptalksMap ref 桥接：从组件实例取 map，再经 composable 创建控件与图层
