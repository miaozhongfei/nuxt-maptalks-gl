<template>
  <div>
    <h1>几何动画</h1>
    <p style="color:#666">使用 useMaptalksGeomAnimate 对 Marker 做变形动画</p>
    <div ref="el" style="height:440px;width:100%;border:1px solid #e0e0e0;border-radius:8px" data-testid="map" />
  </div>
</template>
