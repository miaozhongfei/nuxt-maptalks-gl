...
import { useMaptalksMultiLineString } from '../../composables/geometry/useMaptalksMultiLineString'
import { GEOMETRY_LAYER_KEY } from '../../core/map-context'
import type { MaptalksMultiLineStringOptions, MaptalksEventHandler } from '../../types'
