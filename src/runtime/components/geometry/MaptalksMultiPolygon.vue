...
import { useMaptalksMultiPolygon } from '../../composables/geometry/useMaptalksMultiPolygon'
import { GEOMETRY_LAYER_KEY } from '../../core/map-context'
import type { MaptalksMultiPolygonOptions, MaptalksEventHandler } from '../../types'
