...
import type { MaptalksPolygonCombinedOptions, PolygonCoordinates } from '../types'
...
const props = withDefaults(
  defineProps<{
    ...
    autoDispose?: boolean
    /** 透传给几何构造器的额外选项（含中文字段注释，详见 MaptalksPolygonCombinedOptions） */
    options?: MaptalksPolygonCombinedOptions
  }>(),
